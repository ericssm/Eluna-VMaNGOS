...
void WorldSession::HandleCharCreateOpcode(WorldPackets::Character::CharCreate const& packet)
{
	...
	if (!pNewChar->Create(sObjectMgr.GeneratePlayerLowGuid(), packet.name, packet.race, packet.class_, packet.gender, packet.skin, packet.face, packet.hairStyle, packet.hairColor, packet.facialHair))
	{
